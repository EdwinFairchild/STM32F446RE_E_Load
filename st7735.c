...
#define TFT_BL_H()	(ST7735_BL_GPIO_Port->BSRR	= (1<<ST7735_BL_Pin)) 
#define TFT_BL_L()	(ST7735_BL_GPIO_Port->BSRR 	= (1<<(ST7735_BL_Pin+16)))
#define TFT_CS_H()	(ST7735_CS_GPIO_Port->BSRR	= (1<<ST7735_CS_Pin))
#define TFT_CS_L()	(ST7735_CS_GPIO_Port->BSRR 	= (1<<(ST7735_CS_Pin+16)))
#define TFT_DC_D()	(ST7735_DC_GPIO_Port->BSRR	= (1<<ST7735_DC_Pin))
#define TFT_DC_C()	(ST7735_DC_GPIO_Port->BSRR 	= (1<<(ST7735_DC_Pin+16)))
#define TFT_RES_H()	(ST7735_RES_GPIO_Port->BSRR	= (1<<ST7735_RES_Pin))
#define TFT_RES_L()	(ST7735_RES_GPIO_Port->BSRR	= (1<<(ST7735_RES_Pin+16)))
...
void ST7735_printMsg(uint8_t x , uint8_t y ,char *msg, ...)
{
	...
	ST7735_WriteString(x, y, buff, Font_16x26, ST7735_BLACK, 0xFFFF);
...
void ST7735_FillRectangle(uint16_t x, uint16_t y, uint16_t w, uint16_t h, uint16_t color) {
	...
	uint8_t data[] = { color >> 8, color & 0xFF };
	//HAL_GPIO_WritePin(ST7735_DC_GPIO_Port, ST7735_DC_Pin, GPIO_PIN_SET);
	ST7735_DC_GPIO_Port->BSRR = 1<<ST7735_DC_Pin;
	for (y = h; y > 0; y--) {
		for (x = w; x > 0; x--) {
