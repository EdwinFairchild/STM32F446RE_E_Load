...
extern void i2c_w_byte(uint8_t address, uint8_t *data, uint8_t len);

extern void delayMS(uint32_t ms);
//
//  Send a byte to the command register
//
static uint8_t ssd1306_WriteCommand(uint8_t hi2c, uint8_t command)
{
	i2c_w_byte(0x00, &command , 1);
	return 0;// HAL_I2C_Mem_Write(hi2c, SSD1306_I2C_ADDR, 0x00, 1, &command, 1, 10);
...
void ssd1306_UpdateScreen(uint8_t hi2c)
{
    ...
    for (i = 0; i < 8; i++) {
	    ...
	    i2c_w_byte(0x40, &SSD1306_Buffer[SSD1306_WIDTH * i], SSD1306_WIDTH);
